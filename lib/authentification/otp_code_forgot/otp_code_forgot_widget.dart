...
class OtpCodeForgotWidget extends StatefulWidget {
  const OtpCodeForgotWidget({
    super.key,
...
class _OtpCodeForgotWidgetState extends State<OtpCodeForgotWidget> {
  late OtpCodeForgotModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OtpCodeForgotModel());
        ...
        body: Container(
          decoration: BoxDecoration(
            image: DecorationImage(
              fit: BoxFit.cover,
              image: Image.asset(
                'assets/images/fille_avec_tel.webp',
              ).image,
            ),
          ),
          child: Container(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            if (widget.code ==
                              ...
                              _model.apiResult3ky = await LoginAPICall.call(
                                tel: widget.telephone,
                                password: widget.password,
                              );
