...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    quisineAuthUserSubject.add(
      QuisineAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<QuisineAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  QuisineAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = QuisineAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    quisineAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
