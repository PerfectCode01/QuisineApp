...
class FacturationWidget extends StatefulWidget {
  const FacturationWidget({
    super.key,
  ...
  @override
  State<FacturationWidget> createState() => _FacturationWidgetState();
}

class _FacturationWidgetState extends State<FacturationWidget> {
  late FacturationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FacturationModel());
  }
